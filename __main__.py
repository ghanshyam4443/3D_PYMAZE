...
def main() -> None:
    ...
    pygame.display.set_caption("Ghanshyam's PyMaze Quest")
    ...
    alpha = 0
    fade_in = True
    title_surface = title_font.render("Ghanshyam's PyMaze ", True, BLUE)
    title_surface.set_alpha(alpha)

    copyright_text = normal_font.render("2025 Ghanshyam's PyMaze Quest", True, BLUE)
    ...
    while True:
        ...
        screen.blit(title_surface, (250 - title_surface.get_width() // 2, 5))
